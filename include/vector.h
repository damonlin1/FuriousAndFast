...
/**
 * Returns the distance between two vectors interpreted as Cartesian points.
 *
 * @param p1 The first point
 * @param p2 The second point
 * @return The distance between p1 and p2 interpreted as Cartesian points
 */
...
/**
 * Returns the unit vector representation of a vector.
 *
